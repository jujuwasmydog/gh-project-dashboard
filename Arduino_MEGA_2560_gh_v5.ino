// Arduino_MEGA_2560_v5.ino
// Smart Greenhouse - Mega conversion draft (v5)
// Adds manual override via Serial commands for:
//   - Louvres: AUTO / OPEN / CLOSE / HALF / STOP
//   - Fans:    FAN_AUTO / FAN_50 / FAN_100
//   - Lights:  LIGHT_AUTO / LIGHT_ON / LIGHT_OFF
//
...
static void updateLouvreControlAuto() {
  if (isnan(tavg) || isnan(havg)) return;
