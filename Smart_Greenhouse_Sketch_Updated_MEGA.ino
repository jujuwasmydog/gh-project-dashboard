...
const uint8_t  FAN_PWM_FIXED    = 255;     // fans forced to 100% for now
...
static void updateActuatorCycle() {
  if (louvreState == L_CLOSED) {
    actuators_open(ACT_PWM);
  } else if (louvreState == L_OPEN) {
